---
title: Supervised Image Classificaiton in Python
format:
  html:
    code-fold: false
...
*Note: This image can also be found [here](https://github.com/Brent-Murray/CodingCrossover/tree/main/data) if you are unable to find the image from this assignment.*
...
*Note: A version of these polygons can also be found [here](https://github.com/Brent-Murray/CodingCrossover/tree/main/data) if you are unable to find your polygons from the original assignment.*
...
```{python}
#| tags: []
poly_summary = gdf["lc_class"].value_counts()
poly_summary
```
